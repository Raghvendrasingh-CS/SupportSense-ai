...
export async function processTicket(ticketData, emitFn = null) {
  ...
  try {
    ...
    let debateResult = null;
      ...
      if (triageResult.classification.priority === 'critical') {
...
export function seedDemoTickets() {
  ...
  const allDemos = [
    ...
    { subject: 'How to reset two-factor authentication on new phone', description: 'I got a new phone. How do I reset my 2FA? Please send reset link. No urgency.', requesterId: 'michelle.chen@designstudio.com', priority: 'low' },
    ...
    { subject: 'Request for Microsoft 365 usage report for last quarter', description: 'Could you please send the usage report for last quarter. How do I access this? No urgency.', requesterId: 'sarah.okonkwo@ngo.org', priority: 'low' },
  ];
